...
if not depsonly:
    print("Device %s not found. Attempting to retrieve device repository from EggProphet Github (http://github.com/EggProphet)." % device)
...
if not depsonly:
    githubreq = urllib.request.Request("https://api.github.com/search/repositories?q=%s+user:EggProphet+in:name+fork:true" % device)
    add_auth(githubreq)
    try:

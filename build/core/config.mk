...
PUBLISH_MAVEN_PREBUILT := $(TOP)/vendor/bitter-polonium/build/core/maven_artifact_publish.mk

BUILD_HTTP_PREBUILT := $(TOP)/vendor/bitter-polonium/build/core/http_prebuilt.mk
